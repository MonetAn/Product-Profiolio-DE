    ...
    <div className="space-y-4 rounded-md border border-border p-4 bg-muted/20">
      ...
      <div className="space-y-2 border-t border-border/70 pt-4">
        ...
        <p className="text-[11px] leading-relaxed text-muted-foreground">
          Для ограниченного пользователя выбранный юнит автоматически
          добавится в область доступа. Уведомления каждый пользователь
          настраивает сам через колокольчик.
        </p>
      </div>
    </div>
  );
