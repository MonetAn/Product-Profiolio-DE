-- Глобальный режим тремапа «Бюджет»: dynamic_for_all = false → статичный вью (дефолт).
...
COMMENT ON TABLE public.dashboard_treemap_layout_config IS
  'Singleton: dynamic_for_all — динамический D3-тремап для всех; false — статичный вью.';
